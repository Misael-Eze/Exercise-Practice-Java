...
public class Juego {
    ...
    public void iniciarJugadores(ArrayList<String> nombresDeJugadores) {
        //TODO ---- Mas o me
        boolean estado = true ;
        for (String string : nombresDeJugadores){
            Jugador jugador = new Jugador(string, false);
            jugadores.add(jugador);
        }
        Jugador jugador1 = jugadores.get(0);
        jugador1.setEsTurno(estado);
        jugadores.set(0,jugador1);
    }
    ...
    public void mezclarMazoYrepartirCartas() {
        //TODO ---- Mas o me
        mazo.mezclarMazo();
        mazo.repartirCartas(jugadores.get(0));
        mazo.repartirCartas(jugadores.get(1));
    }
